...
public class BedrockStateTypes {
    ...
    public static final TypeMapping<Integer, Orientation> FACING_DIRECTION_ROTATION_TO_ORIENTATION = new TypeMapping.Builder<Integer, Orientation>()
            .mapping(0, 0, Orientation.DOWN_EAST)
            .mapping(0, 1, Orientation.DOWN_NORTH)
            .mapping(0, 2, Orientation.DOWN_WEST)
            .mapping(0, 3, Orientation.DOWN_SOUTH)
            .mapping(1, 0, Orientation.UP_EAST)
            .mapping(1, 1, Orientation.UP_SOUTH)
            .mapping(1, 2, Orientation.UP_WEST)
            .mapping(1, 3, Orientation.UP_NORTH)
